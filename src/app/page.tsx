    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/20 text-foreground">
        ...
        <div className="container mx-auto px-6 pt-8 pb-20 md:pb-32 lg:px-8 relative z-10">
          <nav className="flex items-center justify-between mb-20">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <Button size="sm" asChild className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-lg">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" asChild className="group bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-xl transform hover:scale-105 transition-transform duration-300">
      ...
      <main className="container mx-auto px-6 lg:px-8 py-16 md:py-24 space-y-24 md:space-y-32">
        ...
        <section id="features" className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Choose <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">SENDORA</span>?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={feature.title} className="text-left backdrop-blur-xl bg-white/60 dark:bg-black/30 border-border shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
        ...
        <section id="how-it-works">
           ...
           <div className="relative">
              <div className="hidden lg:block absolute top-1/2 left-0 w-full h-0.5 bg-secondary"></div>
              <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-12">
                  <div className="flex flex-col items-center text-center">
                      <div className="flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-primary to-accent text-primary-foreground border-4 border-background shadow-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { name: "Elena G.", company: "Blossom & Bloom", quote: "I can't believe it's free to get started. The dashboard gives me great insights into my sales, and managing contacts is now automatic. Highly recommend!" },
               ...
               <Card key={testimonial.name} className="backdrop-blur-xl bg-white/60 dark:bg-black/30 border-border shadow-xl flex flex-col">
